...
const Technology = () => {
  ...
  const getNews = () => {
    axios
      .get(
        `https://api.nytimes.com/svc/news/v3/content/nyt/technology.json?api-key=5Mzr2Dy7me2rLZT4uwoPTK7jVh5opui5`
      )
      .then((response) => {
  ...
  return (
    <div>
      <div className="section-container">
        <ToastContainer />
        <h3 className="section-container-header">TECHNOLOGY</h3>
